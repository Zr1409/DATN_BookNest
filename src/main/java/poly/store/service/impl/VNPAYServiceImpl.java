...
import poly.store.config.VNPAYConfig;
import poly.store.service.VNPAYService;

@Service
public class VNPAYServiceImpl implements VNPAYService {
	@Override
	public String payment(HttpServletRequest request, int amount, String orderInfor, String urlReturn) {
		...
		formatter.setTimeZone(TimeZone.getTimeZone("Asia/Ho_Chi_Minh"));  // BẮT BUỘC

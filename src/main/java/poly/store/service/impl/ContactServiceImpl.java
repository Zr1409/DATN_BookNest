...
//		send mail thanks guests
		mailerService.queue(contactModel.getEmail(), "Thông Báo BookNest.com", 
				"Kính chào " + name +",<br>"
				+ "Đại diện BookNest shop xin chân thành cảm ơn bạn đã ghé qua và để lại đánh giá ý kiến cá nhân về shop. "
	...
	public int countPendingContacts() {
	    return dao.countPendingContacts();	
	}

	@Override
	public int countSuccessContacts() {
	    return dao.countSuccessContacts();
	}

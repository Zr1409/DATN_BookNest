...
public class Constants {
	...
	public static final String USER_DISPLAY_LIST_BOOK_BY_CATEGORY = "user/list/list_by_category";
	// Duong dan den man hinh danh sach uu dai
	public static final String USER_DISPLAY_LIST_BOOK_BY_SALES = "user/list/list_by_sales";
	// Duong dan den man hinh tim kiem
	public static final String USER_DISPLAY_LIST_BOOK_BY_SEARCH = "user/list/list_by_search";
	// Duong dan den man hinh chi tiet san pham
	public static final String USER_DISPLAY_DETAIL_BOOK = "user/detail/product_detail";
	...
	// Duong dan den man hinh cập nhật dia chi
	...
	// Duong dan den man hinh trang quan ly danh sach nhan vien
	public static final String USER_DISPLAY_ADMIN_BOOKCATEGORY_LIST = "admin/bookCategory/list";
	// Duong dan den man hinh trang quan ly thong tin danh muc
	public static final String USER_DISPLAY_ADMIN_BOOKCATEGORY_FORM = "admin/bookCategory/form";
	// Duong dan den man hinh trang quan ly danh sach nhan vien
	public static final String USER_DISPLAY_ADMIN_PUBLISHER_LIST = "admin/publisher/list";
	// Duong dan den man hinh trang quan ly thong tin danh muc
	public static final String USER_DISPLAY_ADMIN_PUBLISHER_FORM = "admin/publisher/form";
	// Duong dan den man hinh trang quan ly thong tin menu bac 1
	public static final String USER_DISPLAY_ADMIN_SUBBOOKCATEGORY_FORM = "admin/subBookCategory/form";
	// Duong dan den man hinh trang quan ly danh sach menu bac 1
	public static final String USER_DISPLAY_ADMIN_SUBBOOKCATEGORY_LIST = "admin/subBookCategory/list";	
	...
	// Duong dan den man hinh trang quan ly danh sach nhan vien
	public static final String USER_DISPLAY_ADMIN_BOOK_LIST = "admin/book/list";
	// Duong dan den man hinh trang quan ly thong tin nhan vien
	public static final String USER_DISPLAY_ADMIN_BOOK_FORM = "admin/book/form";
	...
	public static final String USER_DISPLAY_ADMIN_COMMENT_PENDING = "admin/bookReviews/list_pending";
	// Duong dan den man hinh trang quan ly binh luan
	public static final String USER_DISPLAY_ADMIN_COMMENT_APPROVED = "admin/bookReviews/list_approved";
	...
	public static final String USER_DISPLAY_ADMIN_STATISTICAL_BOOK_DAY = "admin/statisticalBook/top_book";
	// Duong dan den man hinh trang thong ke san pham ton kho
		public static final String USER_DISPLAY_ADMIN_STATISTICAL_WAREHOUSE_BOOK = "admin/statisticalBook/warehouse_book";
